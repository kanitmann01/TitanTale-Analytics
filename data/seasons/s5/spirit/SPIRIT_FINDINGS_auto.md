...
Season: s5. Source: `D:\TWorkshop\Dev Tools\TTL Stats\data\ttl_s5_matches.csv`.
...
**Test:** Fisher exact (one-sided, vs symmetric table)

**n:** 136

**95% Wilson CI (proportion):** 82.6% - 93.2%
...
**Test:** Binomial test (two-sided vs 50%)

**n:** 546

**95% Wilson CI (proportion):** 70.3% - 77.7%
...
**Test:** Chi-square test on 3x2 contingency (higher-ELO win/loss by bucket)
...
**Test:** Per-player binomial vs overall WR (two-sided); multiple comparisons
...
**Test:** Binomial per pair (one-sided vs 50%); multiple comparisons across pairs
...
**Test:** Per cell binomial vs player baseline (two-sided); multiple comparisons
...
**Test:** Binomial test (upset count vs mean expected upset rate)

**n:** 546

**95% Wilson CI (proportion):** 54.6% - 62.8%
...
**Test:** Spearman correlation (duration CV vs win rate across players)

**n:** 20

**Verdict:** BUSTED

![Tempo Control](assets/spirit/tempo_control.png)
